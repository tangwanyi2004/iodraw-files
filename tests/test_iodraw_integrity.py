...
class IodrawIntegrityTest(unittest.TestCase):
    ...
    def test_left_and_right_parking_success_branches_target_correct_slots(self):
        ...
        self.assertIn(
            "倒车入库至左边车位",
            _plain_value(cells_by_id["2C-E8wXzLExmKxaGtvue-101"]),
        )
        self.assertIn(
            "倒车入库至右边车位",
            _plain_value(cells_by_id["2C-E8wXzLExmKxaGtvue-110"]),
        )
        ...
        self.assertEqual(
            ...
            parking_edges["2C-E8wXzLExmKxaGtvue-101"],
        )
        self.assertEqual(
            "2C-E8wXzLExmKxaGtvue-115",
            parking_edges["2C-E8wXzLExmKxaGtvue-110"],
        )
